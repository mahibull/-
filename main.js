    ...
    break;
      ...
      case "নাজমুল":
        ...
        break;
                ...
                case "মিম আক্তার":
                case "Mim Akter":
                document.getElementById('tv').innerHTML = "দেখতে সুন্দরী এবং পর্দাশীল সব সমায় হিজাব পরে <br>😜 হিজাব তো মিয়া খলিফাও,পরে"; 
                break;

                //Sabbir
                case "ছাব্বির":
                case "Sabbir":
                document.getElementById('tv').innerHTML = "বাংলাদেশের এক নাম্বার ধান্দাবাজ-"; 
                break;
